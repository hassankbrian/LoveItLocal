...
$sections[] = array(
				...
				'fields' => array(
                   ...
                   array(
						'id' => 'first-title',
						'type' => 'text',
						'title' => __('First Title','SimpleKey'),
						'sub_desc' => __('It will be displayed on homepage top area if there is no slides.','SimpleKey'),
                   ...
                   array(
						'id' => 'second-title',
						'type' => 'text',
						'title' => __('Second Title','SimpleKey'),
						'sub_desc' => __('It will be displayed on homepage top area if there is no slides.','SimpleKey'),
				    ...
				    array(
						'id' => 'intro',
						'type' => 'textarea',
						'title' => __('Site introduction','SimpleKey'),
						'validate' => 'no_html',
						'sub_desc' => __('It will be displayed on homepage top area if there is no slides.','SimpleKey'),
						'std' => ''
						),
				  ...
				  array(
				   ...
				   array(
				    ...
				    array(
						'id' => 'slideTransitionSpeed',
						'type' => 'text',
						'title' => __('Slider Transition Speed','SimpleKey'),
						'validate' => 'no_html',
						'sub_desc' => __('Default is 600 millisecond','SimpleKey'),
						'desc' => __('millisecond','SimpleKey'),
						'std' => 600
						),
					...
					array(
						'id' => 'slidespeed',
						'type' => 'text',
						'title' => __('Slider playing speed','SimpleKey'),
						'validate' => 'no_html',
						'sub_desc' => __('Default is 7000 millisecond','SimpleKey'),
						'desc' => __('millisecond','SimpleKey'),
						'std' => 7000
						),
				   ...
				   array(
						...
						'title' => __('Disable the page loading','SimpleKey'),
						'sub_desc' => '',
						'std' => 1
						),
					...
					array(
						...
						'type' => 'button_set',
						'options' => array('1' => 'No', '0' => 'Yes'),
						'title' => __('Disable Retina Support','SimpleKey'),
						'sub_desc' => '',
						'std' => 0
						),
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'myspace',
						'type' => 'text',
						'title' => __('Myspace URL','SimpleKey'),
						'validate' => 'no_html',
						'sub_desc' =>'',
						'std' => ''
						),
...
$sections[] = array(
				...
				'fields' => array(
				   ...
				   array(
				    ...
				    array(						
					    'id' => 'slider_headtitle_font',
						'title' => __('Slider Head Title Font:','SimpleKey'),
						'type' => 'select',
						'options' => $google_webfonts,
						'sub_desc' => __('Change the slider head title font,it is not act on mobile Phone device.','SimpleKey'),
						'desc'=>__('Preview the font in <a href="http://www.google.com/webfonts" target="_blank">google fonts</a>','SimpleKey'),
						'std' => 'league_gothic'
						),
					
					array(						
					    'id' => 'slider_subtitle_font',
						'title' => __('Slider Sub Title Font:'),
						'type' => 'select',
						'options' => $google_webfonts,
						'sub_desc' => __('Change the slider sub title font,it is not act on mobile Phone device.','SimpleKey'),
						'desc'=>__('Preview the font in <a href="http://www.google.com/webfonts" target="_blank">google fonts</a>','SimpleKey'),
						'std' => 'infinity'
						),
										
					array(						
					    'id' => 'slider_headtitle_bigsize',
						'title' => __('The Bigger Font Size of Slider Head Title:','SimpleKey'),
						'type' => 'text',
						'sub_desc' => __('For one column situation','SimpleKey'),
						'desc'=> __('px'),
						'std' => '160'
						),
					
					array(						
					    'id' => 'slider_headtitle_smallsize',
						'title' => __('The smaller Font Size of Slider Head Title:','SimpleKey'),
						'type' => 'text',
						'sub_desc' => __('For two columns situation','SimpleKey'),
						'desc'=> __('px'),
						'std' => '100'
						),
						
					array(						
					    'id' => 'slider_subtitle_bigsize',
						'title' => __('The Bigger Font Size of Slider Sub Title:','SimpleKey'),
						'type' => 'text',
						'sub_desc' => __('For one column situation','SimpleKey'),
						'desc'=> __('px'),
						'std' => '72'
					...
					array(						
					    'id' => 'slider_subtitle_smallsize',
						'title' => __('The smaller Font Size of Slider Sub Title:','SimpleKey'),
						'type' => 'text',
						'sub_desc' => __('For two columns situation','SimpleKey'),
						'desc'=> __('px'),
						'std' => '36'
