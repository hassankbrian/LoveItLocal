...
<?php }else{ ?>
  ...
  <form id="contactForm" method="post" action="?">
   ...
   <label><textarea class="requiredField" name="comments" id="comments" placeholder="<?php _e('Message','SimpleKey');?>"><?php 
    ...
    <div class="cp">
    <input type="text" name="captcha" id="captcha" value="" class="requiredField captcha" placeholder="<?php _e('Captcha','SimpleKey');?>" /><a href="javascript:refreshCaptcha();" class="cpt-img"><img id="mycaptcha" src="<?php echo get_template_directory_uri();?>/functions/captcha/van_captcha.php?rand=<?php echo rand();?>" /></a>
    </div>
