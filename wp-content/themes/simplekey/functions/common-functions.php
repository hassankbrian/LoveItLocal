...
function van_social(){
  global $VAN;
  $social='<div class="social-icons">'.PHP_EOL;
  if(isset($VAN['googlplus']) && $VAN['googlplus']<>'')
	$social.='<a href="'.$VAN['googlplus'].'" title="Google+" class="gplus" target="_blank">Google+</a> '.PHP_EOL;
  if(isset($VAN['facebook']) && $VAN['facebook']<>'')
	$social.='<a href="'.$VAN['facebook'].'" title="Facebook" class="facebook" target="_blank">Facebook</a> '.PHP_EOL;
  if(isset($VAN['twitter']) && $VAN['twitter']<>'')
	$social.=' <a href="'.$VAN['twitter'].'" title="Twitter" class="twitter" target="_blank">Twitter</a> '.PHP_EOL;
  if(isset($VAN['deviantart']) && $VAN['deviantart']<>'')
	$social.='<a href="'.$VAN['deviantart'].'" title="Deviantart" class="deviantart" target="_blank">Deviantart</a>'.PHP_EOL;
  if(isset($VAN['tumblr']) && $VAN['tumblr']<>'')
	$social.='<a href="'.$VAN['tumblr'].'" title="tumblr" class="tumblr" target="_blank">Tumblr</a>  '.PHP_EOL;
  if(isset($VAN['flickr']) && $VAN['flickr']<>'')
	$social.='<a href="'.$VAN['flickr'].'" title="Flickr" class="flickr" target="_blank">Flickr</a> '.PHP_EOL;
  if(isset($VAN['behance']) && $VAN['behance']<>'')
	$social.='<a href="'.$VAN['behance'].'" title="Behance" class="behance" target="_blank">Behance</a> '.PHP_EOL;
  if(isset($VAN['dribbble']) && $VAN['dribbble']<>'')
	$social.='<a href="'.$VAN['dribbble'].'" title="Dribbble" class="dribbble" target="_blank">Dribbble</a> '.PHP_EOL;
  if(isset($VAN['pinterest']) && $VAN['pinterest']<>'')
	$social.='<a href="'.$VAN['pinterest'].'" title="Pinterest" class="pinterest" target="_blank">Pinterest</a>'.PHP_EOL;
  if(isset($VAN['youtube']) && $VAN['youtube']<>'')
	$social.='<a href="'.$VAN['youtube'].'" title="Youtube" class="youtube" target="_blank">Youtube</a>'.PHP_EOL;
  if(isset($VAN['vimeo']) && $VAN['vimeo']<>'')
	$social.='<a href="'.$VAN['vimeo'].'" title="Vimeo" class="vimeo" target="_blank">Vimeo</a>'.PHP_EOL;
  if(isset($VAN['linkedIn']) && $VAN['linkedIn']<>'')
	$social.='<a href="'.$VAN['linkedIn'].'" title="linkedIn" class="linkedIn" target="_blank">linkedIn</a>'.PHP_EOL;
  if(isset($VAN['soundCloud']) && $VAN['soundCloud']<>'')
	$social.='<a href="'.$VAN['soundCloud'].'" title="SoundCloud" class="soundcloud" target="_blank">SoundCloud</a>'.PHP_EOL;
  if(isset($VAN['myspace']) && $VAN['myspace']<>'')
	$social.='<a href="'.$VAN['myspace'].'" title="Myspace" class="myspace" target="_blank">Myspace</a>'.PHP_EOL;
  if(isset($VAN['myemail']) && $VAN['myemail']<>'')
	$social.='<a href="mailto:'.$VAN['myemail'].'" title="Email" class="myemail" target="_blank">Email</a>'.PHP_EOL;
  if(isset($VAN['yahooim']) && $VAN['yahooim']<>'')
	$social.='<a href="ymsgr:sendIM?'.$VAN['yahooim'].'" title="Yahoo IM" class="yahooim" target="_blank">Yahoo IM</a>'.PHP_EOL;
  if(isset($VAN['aim']) && $VAN['aim']<>'')
	$social.='<a href="aim:GoIm?screenname=?'.$VAN['aim'].'" title="AIM" class="aim" target="_blank">AIM</a>'.PHP_EOL;
  if(isset($VAN['instagram']) && $VAN['instagram']<>'')
	$social.='<a href="'.$VAN['instagram'].'" title="instagram" class="instagram" target="_blank">instagram</a> '.PHP_EOL;
  if(isset($VAN['meetup']) && $VAN['meetup']<>'')
	$social.='<a href="'.$VAN['meetup'].'" title="meetup" class="meetup" target="_blank">meetup</a> '.PHP_EOL;
  if(isset($VAN['xing']) && $VAN['xing']<>'')
	$social.='<a href="'.$VAN['xing'].'" title="Xing" class="xing" target="_blank">Xing</a> '.PHP_EOL;
  if(isset($VAN['klout']) && $VAN['klout']<>'')
	$social.='<a href="'.$VAN['klout'].'" title="klout" class="klout" target="_blank">klout</a> '.PHP_EOL;
  if(isset($VAN['rss']) && $VAN['rss']<>'')
	$social.='<a href="'.$VAN['rss'].'" title="Feed" class="feed" target="_blank">Feed</a> '.PHP_EOL;
  $social.='</div>'.PHP_EOL;
...
function van_shortcode($content){
   ...
   return do_shortcode(strip_tags($content, "<h1><h2><h3><h4><h5><h6><a><img><embed><iframe><form><input><button><object><div><ul><li><ol><table><td><th><span><p><br/><strong><em><del>"));
}
